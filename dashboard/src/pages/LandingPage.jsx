  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
        ...
        {/* Logo & Branding */}
        <div className="relative z-10 text-center mb-8" style={{ animation: 'fadeInUp 1s ease-out' }}>
          <div className="flex items-center justify-center gap-4 mb-6">
            <Zap className="w-12 h-12 text-amber-400" style={{ filter: 'drop-shadow(0 0 15px rgba(245,158,11,0.6))' }} />
            <div>
              <h1
                className="font-orbitron text-5xl md:text-7xl font-black tracking-[0.2em] text-amber-400"
                style={{ textShadow: '0 0 30px rgba(245,158,11,0.4), 0 0 60px rgba(245,158,11,0.15)' }}
              >
                APEX CORTEX
              </h1>
              <div className="font-mono-tech text-xs md:text-sm tracking-[0.5em] text-neutral-500 mt-1">
          ...
          <p
            className="font-rajdhani text-xl md:text-2xl text-neutral-400 italic max-w-xl mx-auto mb-2"
            style={{ animation: 'fadeInUp 1s ease-out 0.3s both' }}
          >
            "Every millisecond. Every molecule. Every edge."
          </p>
          <p
            className="font-rajdhani text-base text-neutral-600 max-w-lg mx-auto"
        ...
        {/* Live Stats Bar */}
        <div
          className="relative z-10 flex items-center gap-6 md:gap-10 mb-12"
          style={{ animation: 'fadeInUp 1s ease-out 0.7s both' }}
        >
          <div className="text-center">
            <div className="font-orbitron text-3xl md:text-4xl font-black text-amber-400 text-glow-amber">
              <AnimatedNumber value={speed} />
            </div>
            <div className="font-mono-tech text-[10px] text-neutral-600 tracking-widest">KM/H</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="font-mono-tech text-[10px] text-neutral-600 tracking-widest">RPM</div>
          </div>
          <div className="w-px h-12 bg-neutral-800 hidden md:block" />
          <div className="text-center hidden md:block">
            <div className="font-orbitron text-2xl font-bold text-amber-300">
              {formatTime(lapTime)}
            </div>
            <div className="font-mono-tech text-[10px] text-neutral-600 tracking-widest">LAP TIME</div>
          </div>
        </div>
        ...
        >
          <button
            ...
            className="group flex items-center gap-3 px-8 py-3 bg-amber-500/10 border-2 border-amber-500 rounded-lg
                       font-orbitron text-sm font-bold tracking-wider text-amber-400
          ...
          <button
            ...
            className="flex items-center gap-3 px-8 py-3 bg-neutral-800/50 border border-neutral-700 rounded-lg
                       font-orbitron text-sm font-bold tracking-wider text-neutral-400
        ...
        <div
          className="relative z-10 w-full max-w-2xl mx-auto opacity-40 hover:opacity-70 transition-opacity duration-500"
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-orbitron text-2xl md:text-3xl font-bold tracking-wider text-amber-400 text-glow-amber mb-3">
              ENGINEERED FOR THE EDGE
            </h2>
            <p className="font-rajdhani text-lg text-neutral-500 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((feat, i) => {
              ...
              return (
                <div
                  key={i}
                  className="panel-carbon p-5 group hover:border-amber-500/30 transition-all duration-300"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-orbitron text-sm font-bold tracking-wider text-neutral-200 mb-1">
                        {feat.title.toUpperCase()}
                      </h3>
                      <p className="font-rajdhani text-sm text-neutral-500 leading-relaxed">
                        {feat.desc}
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-16 px-4 border-t border-neutral-800/50">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="font-orbitron text-xl font-bold tracking-wider text-neutral-400 mb-8">
            SUPPORTED PLATFORMS
          </h2>
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {['Mercedes-AMG', 'BMW M', 'Audi RS', 'Porsche GT', 'OBD-II Generic'].map((brand) => (
              <div
                key={brand}
                className="px-5 py-2.5 border border-neutral-800 rounded-lg font-orbitron text-xs tracking-wider text-neutral-500
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          LIVE DEMO SECTION - Nürburgring Simulation
          ═══════════════════════════════════════════════════════════════════ */}
      <section
        ref={demoRef}
        className="py-16 px-4 border-t border-neutral-800/50"
        id="live-demo"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-full mb-4">
              ...
              <span className="font-mono-tech text-xs text-amber-400 tracking-wider">LIVE SIMULATION</span>
            </div>
            <h2 className="font-orbitron text-2xl md:text-3xl font-bold tracking-wider text-amber-400 text-glow-amber mb-2">
              NURBURGRING NORDSCHLEIFE
            </h2>
            <p className="font-rajdhani text-lg text-neutral-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 mb-4">
            {/* Track Map - 3 cols */}
            <div className="lg:col-span-3 panel-carbon p-4 relative" style={{ minHeight: '400px' }}>
            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
              {/* Big Speed Display */}
              <div className="panel-carbon p-6 text-center flex-1 flex flex-col justify-center">
                <div
                  className="font-orbitron text-[80px] md:text-[100px] font-black leading-none text-amber-400"
                  style={{ textShadow: '0 0 30px rgba(245,158,11,0.4), 0 0 60px rgba(245,158,11,0.15)', letterSpacing: '-0.02em' }}
                >
                  {formatSpeed(speed)}
                </div>
                <div className="font-mono-tech text-xs text-neutral-500 tracking-[0.3em] -mt-1">KM/H</div>

                <div className="flex items-center justify-center gap-8 mt-4">
                  <div className="text-center">
                    <div className="font-mono-tech text-[10px] text-neutral-600 tracking-widest">GEAR</div>
                    <div
                      className={`font-orbitron text-4xl font-black ${shiftNow ? 'shift-light-blink' : ''}`}
                  ...
                  <div className="text-center">
                    ...
                    <div className="font-orbitron text-lg font-bold text-amber-300">
                      {formatTime(lapTime)}
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="panel-carbon p-3 text-center">
                  <div className="font-mono-tech text-[10px] text-neutral-600 tracking-widest mb-1">G-LAT</div>
                  <div className="font-orbitron text-xl font-bold text-amber-400">
                    {(gLat ?? 0).toFixed(2)}
                  </div>
                </div>
                <div className="panel-carbon p-3 text-center">
          ...
          <div className="text-center mt-12">
            <button
              onClick={onEnterDashboard}
              className="group inline-flex items-center gap-3 px-10 py-4 bg-amber-500/10 border-2 border-amber-500 rounded-lg
                         font-orbitron text-base font-bold tracking-wider text-amber-400
            ...
            <p className="font-mono-tech text-xs text-neutral-600 mt-3 tracking-wider">
