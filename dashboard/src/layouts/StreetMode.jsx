  ...
  return (
    <div className="panel-carbon p-3">
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <span className="text-[10px] font-mono-tech text-neutral-500 tracking-widest">{label}</span>
      </div>
      <div className="font-orbitron text-2xl font-bold mb-2" style={{ color }}>
        {displayValue ?? '--'}
      </div>
...
export default function StreetMode({ data, history, connected }) {
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          <div className="font-orbitron text-2xl text-neutral-600 mb-2">STREET MODE</div>
  ...
  return (
    <div className="h-full flex flex-col p-4 gap-4 max-w-4xl mx-auto">
      ...
      <div className="panel-carbon p-3">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[10px] font-mono-tech text-neutral-500 tracking-widest">ENGINE LOAD</span>
