    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          <div className="font-orbitron text-2xl text-neutral-600 mb-2">AWAITING TELEMETRY</div>
    ...
    <div className="h-full flex flex-col p-2 gap-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col items-center w-32">
          <div className="text-[10px] font-mono-tech text-neutral-600 tracking-widest">GEAR</div>
          <div
            className={`font-orbitron text-7xl font-black leading-none ${shiftNow ? 'shift-light-blink' : ''}`}
            style={{
              color: gearColor,
        ...
        <div className="flex-1 text-center">
          <div
            className="font-orbitron text-[120px] font-black leading-none text-amber-400 text-glow-amber"
            style={{ letterSpacing: '-0.02em' }}
          >
            {formatSpeed(speed)}
          </div>
          <div className="text-xs font-mono-tech text-neutral-500 tracking-[0.3em] -mt-2">KM/H</div>
        </div>

        {/* Lap time - right */}
        <div className="flex flex-col items-center w-48">
          <div className="text-[10px] font-mono-tech text-neutral-600 tracking-widest">LAP TIME</div>
          <div className="font-orbitron text-2xl font-bold text-amber-300 tracking-wider">
            {formatTime(lapTime)}
          </div>
          <div className="flex gap-3 mt-1">
            <div className="text-center">
              <div className="text-[9px] font-mono-tech text-neutral-600">BEST</div>
              <div className="text-xs font-mono-tech text-amber-400/70">{formatTime(bestLap)}</div>
            </div>
            <div className="text-center">
              <div className="text-[9px] font-mono-tech text-neutral-600">DELTA</div>
              <div
